...
namespace AI4E.Modularity
{
    ...
    public interface IMessageEndPoint : IAsyncInitialization, IAsyncCompletion
    {
        ...
        Task<IHandlerRegistration> RegisterAsync<TMessage>(IHandlerFactory<IMessageHandler<TMessage>> handlerFactory); // TODO: Correct xml-comments
        ...
        /// </returns>
        ///  <exception cref="ArgumentNullException">Thrown if <paramref name="handlerFactory"/> is null.</exception>
        Task<IHandlerRegistration> RegisterAsync<TMessage, TResponse>(IHandlerFactory<IMessageHandler<TMessage, TResponse>> handlerFactory); // TODO: Correct xml-comments
