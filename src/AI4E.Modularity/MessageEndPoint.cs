...
namespace AI4E.Modularity
{
    ...
    public sealed partial class MessageEndPoint : IMessageEndPoint
    {
        ...
        public async Task<IHandlerRegistration> RegisterAsync<TMessage>(IHandlerFactory<IMessageHandler<TMessage>> handlerFactory) // TODO: Correct xml-comments
        {
        ...
        /// </returns>
        ///  <exception cref="ArgumentNullException">Thrown if <paramref name="handlerFactory"/> is null.</exception>
        public async Task<IHandlerRegistration> RegisterAsync<TMessage, TResponse>(IHandlerFactory<IMessageHandler<TMessage, TResponse>> handlerFactory) // TODO: Correct xml-comments
        {
            if (handlerFactory == null)
                throw new ArgumentNullException(nameof(handlerFactory));
