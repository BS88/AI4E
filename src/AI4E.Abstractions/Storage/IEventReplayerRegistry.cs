...
namespace AI4E.Storage
{
        ...
        where TId : struct, IEquatable<TId>
    {
        ...
        Task<IHandlerRegistration> RegisterAsync<TEvent, TEntity>(IHandlerFactory<IEventReplayer<TId, TEventBase, TEntityBase, TEvent, TEntity>> eventReplayerFactory)
    ...
    {
        Task<IHandlerRegistration> RegisterAsync(IHandlerFactory<IEventReplayer<TId, TEventBase, TEntityBase, TEvent, TEntity>> eventReplayerFactory);
