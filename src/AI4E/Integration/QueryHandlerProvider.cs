...
{
    public sealed class QueryHandlerProvider<TQuery> : IHandlerFactory<IQueryHandler<TQuery>>
    {
        ...
        public IQueryHandler<TQuery> GetHandler(IServiceProvider serviceProvider)
        {
